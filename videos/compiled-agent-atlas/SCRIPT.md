...
**Voice direction:** Precise technical broadcaster with contained urgency. Every act begins with a clean declarative title. Pause before caveats; treat evidence labels as verdicts, not hype.

---

## Line 1 — The monolith (Frame 1)
...
**Time:** 150.0 – 175.0s
**Delivery:** Practical checklist energy; punch effective catalog.

    That makes an extension a trust composition, not a feature checkbox. Pin its component type, declared name, source scope, resolved location, and digest—then inspect the effective catalog.

## Line 9 — Boundary: non-equivalent controls (Frame 9)
